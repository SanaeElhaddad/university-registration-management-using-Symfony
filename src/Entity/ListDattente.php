...
#[ORM\Entity(repositoryClass: ListDattenteRepository::class)]
class ListDattente
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    public function getNoteBa(): ?string
    {
        return $this->note_ba;
    }

    public function setNoteBa(string $note_ba): static
    {
        $this->note_ba = $note_ba;
