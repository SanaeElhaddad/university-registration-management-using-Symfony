 ...
 */
final class Version20231226144822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etudiant CHANGE attestation_reussite attestation_reussite VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE etudiant CHANGE attestation_reussite attestation_reussite VARCHAR(255) NOT NULL');
    }
}
