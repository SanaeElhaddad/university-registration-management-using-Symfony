 ...
 */
final class Version20231225200640 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE etudiant (id INT AUTO_INCREMENT NOT NULL, filiere_id INT NOT NULL, cne VARCHAR(255) NOT NULL, cin VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, date_naissance DATE NOT NULL, telephone VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, genre VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, adresse_postale VARCHAR(255) NOT NULL, nationalite VARCHAR(255) NOT NULL, profession_pere VARCHAR(255) NOT NULL, profession_mere VARCHAR(255) NOT NULL, gsm_mere VARCHAR(255) NOT NULL, gsm_pere VARCHAR(255) NOT NULL, mot_passe VARCHAR(255) NOT NULL, confirm_pass VARCHAR(255) NOT NULL, status TINYINT(1) DEFAULT NULL, INDEX IDX_717E22E3180AA129 (filiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
